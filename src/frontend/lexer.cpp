// Module: Snow lexer/tokenization implementation.
// Invariant: produced token ranges are monotonic and map directly to source spans for diagnostics.
...
namespace snow::frontend {
    ...
    namespace {
        ...
        Token MakeToken(const TokenType type, const std::string &lexeme, const std::size_t line,
                        const std::size_t column, const std::size_t end_line, const std::size_t end_column) {
            return Token{
                    .type = type,
                    .lexeme = lexeme,
    ...
    TokenStream Lexer::Tokenize(const snow::common::SourceFile &source,
