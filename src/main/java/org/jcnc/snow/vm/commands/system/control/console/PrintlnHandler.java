...
/**
 * <p>
 * {@code PrintlnHandler} 是一个系统调用处理器，实现虚拟机中的带换行的标准输出功能（类似于控制台的 println）。
 * 该处理器会从操作数栈弹出一个对象，并通过 {@link SyscallUtils#output(Object, boolean)} 方法打印到输出流，输出后自动换行。
 * </p>
 *
 * <p>
